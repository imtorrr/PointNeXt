...
if __name__ == "__main__":
    ...
    cfg.csv_path = os.path.join(cfg.run_dir, cfg.run_name + "_allareas.csv")
    ...
    cfg.allarea_cm = ConfusionMatrix(
    ...
    for i in range(1, 7):  # 6 areas
        ...
        for pretrained in pretrained_paths_unorder:
            if f"test_area={i}" in pretrained:
                ...
                break
            if "test_area" not in pretrained and i == 5:
                pretrained_path = pretrained
    ...
    write_to_csv(oa, macc, miou, ious, "-", cfg, write_header=False, area="all")
